...
inline void threadedAlgorithm(std::string inputFilePath, std::string outputFilePath, size_t height, size_t width, size_t radius) {
...
#pragma omp parallel for schedule(dynamic)
  for (int32_t y1 = 0; y1 < (int32_t)height; ++y1) {
